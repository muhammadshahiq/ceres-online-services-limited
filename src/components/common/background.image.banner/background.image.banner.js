            ...
            <Container maxWidth='xl' className={clsx((mobileWidth || tabletWidth) && 'pl-0 pr-0 position-relative pt-5')}>
                <Grid container>
                    <Grid item xs={12} sm={12} md={6} lg={6} className={clsx(!(mobileWidth || tabletWidth) && 'pt-5 pb-5', mobileWidth && 'pt-5 pb-2')}>
                        <Container maxWidth='xs' className={clsx(!(mobileWidth || tabletWidth) && 'pt-3 pb-3 pl-0 pr-0')}>
                            <AppContentBox
                                title={title}
                                label={label}
                                description={description}
                            />
                            <Box className={clsx(!(mobileWidth || tabletWidth) && 'mt-4 d-flex justify-content-between align-items-center', mobileWidth && 'pt-2 pb-2 d-flex flex-column justify-content-center align-items-start', 'w-100 position-relative')}>
                                {buttonText ?
                                    <div className={clsx(!(mobileWidth || tabletWidth) && 'w-50', mobileWidth && 'w-100 pt-1 pb-2')}>
                                        <AppButton buttonText={buttonText} />
                                    </div>
                                    : null}
                                {tickerImages ?
                                    <div className={clsx(!(mobileWidth || tabletWidth) && 'w-50', mobileWidth && 'w-100 pt-1 pb-1')}>
                    ...
                    <Grid item xs={12} sm={12} md={6} lg={6} className='w-100'>
                        {image ? <div>
                            <img
                                src={image}
                                height={!(mobileWidth || tabletWidth) ? '520px' : tabletWidth ? '400px' : '190px'}
                                width='100%'
                            />
                        </div> : null
                        }
