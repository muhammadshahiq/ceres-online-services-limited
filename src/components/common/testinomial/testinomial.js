...
const Testinomial = (props) => {
  ...
  return (
    <Slider {...settings} className="d-flex justify-content-center pt-3 pb-3 mt-3 mb-3 overflow-hidden">
      {testinomialData && testinomialData.map((data, index) => {
        return <div className='w-100 text-center d-flex justify-content-center'>
          <div key={index} className="w-80 position-relative">
            <div>
